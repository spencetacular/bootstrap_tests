...
class HospitalsControllerTest < ActionController::TestCase
  ...
  test "should create hospital" do
    assert_difference('Hospital.count') do
      post :create, hospital: { address: @hospital.address, description: @hospital.description, name: @hospital.name }
    end
  ...
  test "should update hospital" do
    patch :update, id: @hospital, hospital: { address: @hospital.address, description: @hospital.description, name: @hospital.name }
    assert_redirected_to hospital_path(assigns(:hospital))
  end
